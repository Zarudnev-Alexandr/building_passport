                ...
                <div className="ForAds__block2">
                    <div className="container">
                        <div className="ForAds__block2-describe2">
                            Электронный технический паспорт здания  объединяет как эксплуатационные, включающие  конструктивные элементы, оборудование, инженерные сети, а также такие энергетические характеристики, как энергоэффективность объекта, способы и виды учета энергоресурсов.
                        </div>
                    </div>
                </div>
                <div className="ForAds__block2">
                    <div className="container">
                        <div className="ForAds__block2-describe2">
                            В состав Орловского Госуниверситета входят 17 учебно-лабораторных корпусов, студенческая поликлиника, 9 общежитий, база отдыха, спортивный комплекс с бассейном.
